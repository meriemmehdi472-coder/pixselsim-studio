...
ActiveRecord::Schema[7.2].define(version: 2026_03_13_003521) do
  ...
  create_table "media_files", force: :cascade do |t|
    ...
    t.bigint "parent_id"
    t.text "crop_params"
    t.index ["parent_id"], name: "index_media_files_on_parent_id"
  ...
  add_foreign_key "media_files", "media_files", column: "parent_id"
